...
Rule for printing a parser error:
	say "Provjeri da li je sve dobro napisano."
...
[*****Predvorje*****]
The Predvorje is a room."Trenutno je [1 minute after the time of day] sati."
...
After taking the igrica:
	if the time of day is before 02:00 pm:
		say "Izgleda da si obavio sve zadatke i da smiješ na igranje kod prijatelja. [bold type]Igra je završena.[roman type]";
	otherwise:
		say "Izgleda da nisi stigao sve obaviti na vrijeme da bi išao kod prijatelja";
	end the story.
